...
## Please make sure you are assigned to an [Issue](https://github.com/pattarai/g-meet-turn-off-cam-unattended/issues) before submitting a pull request

Go to the [issue](https://github.com/pattarai/g-meet-turn-off-cam-unattended/issues) page and either
...
```
git remote add upstream https://github.com/pattarai/g-meet-turn-off-cam-unattended.git
